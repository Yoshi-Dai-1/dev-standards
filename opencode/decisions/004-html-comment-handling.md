...
- **`.opencode/instructions/agents-fill-guide.md`** で明示しない限り AI は HTML コメントを保持しない。保存が必要なセクションには preservation ルールを記述する
...
良い影響：
- AI が write_file 時に誤削除する問題が、`.opencode/instructions/agents-fill-guide.md` の preservation ルール + 可視テキスト化の併用で解決される
